...
# Calculate the number of days left from each event and add them into a list of lists, and sort it by the days left, and remove the events that already passed
events = get_events()
